...
Line.prototype.draw = function () {
	...
	for (let i = 0; i < this.data.length; i++) {
		this.drawCircle(graph, padding + innerPadding + pointGap * i, padding + axisHeight - this.data[i] * rate, 5, pointColor);
		if (i > 0) {
			this.drawLine(graph, padding + innerPadding + pointGap * (i - 1), padding + axisHeight - this.data[i - 1] * rate, padding + innerPadding + pointGap * i, padding + axisHeight - this.data[i] * rate, lineColor);
		}
	}
